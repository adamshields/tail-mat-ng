...
import { BreakerMockApiReplyCallback } from './mock-api.types';

export class BreakerMockApiHandler
{
    request!: HttpRequest<any>;
    urlParams!: { [key: string]: string };

    // Private
    private _reply: BreakerMockApiReplyCallback = undefined;
     ...
     * @param callback
     */
    reply(callback: BreakerMockApiReplyCallback): void
    {
        // Store the reply
