...
import { BreakerMockApiService } from './mock-api.service';

@Injectable({
    providedIn: 'root'
})
export class BreakerMockApiInterceptor implements HttpInterceptor
{
    /**
     * Constructor
     */
    constructor(
        @Inject(BREAKER_MOCK_API_DEFAULT_DELAY) private _defaultDelay: number,
        private _fuseMockApiService: BreakerMockApiService
    )
    {
    }
